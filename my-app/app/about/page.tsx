            ...
            <section className="container max-w-4xl px-4 py-8 mx-auto">
                ...
                <div className="grid items-center gap-8 mb-12 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <h2 className="mb-4 text-2xl font-semibold">Empowering Makers Worldwide</h2>
            ...
            <section className="container max-w-3xl px-4 py-8 mx-auto">
                <div className="prose max-w-none">
                    ...
                    <p className="mb-4 text-gray-700">
                        ...
                        create, prototype, and manufacture. Our platform serves as a bridge between
                        designers and makers, enabling the sharing of knowledge and creativity that
                        pushes the boundaries of what&apos;s possible with 3D printing.
                    </p>
                    <p className="text-gray-700">
                        Whether you&apos;re a hobbyist looking for your next weekend project, an
                        educator seeking teaching materials, or a professional designer wanting to
                        share your creations, PrintForge provides the tools and community to support
